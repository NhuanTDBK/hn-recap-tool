...
class TestBaseAgent:
    ...
    def test_agent_has_openai_agent(self, base_agent):
        """Test agent has initialized OpenAI Agents SDK Agent."""
        assert base_agent.agent is not None
        assert base_agent.agent.__class__.__name__ == "Agent"
    ...
    def test_agent_model_configuration(self):
        ...
        agent_mini = BaseAgent("Test", "You are helpful.", model="gpt-4o-mini")
        agent_4o = BaseAgent("Test", "You are helpful.", model="gpt-4o")
    ...
    def test_agent_temperature_range(self):
        ...
        agent_deterministic = BaseAgent("Test", "You are helpful.", temperature=0.0)
        agent_balanced = BaseAgent("Test", "You are helpful.", temperature=0.5)
        agent_creative = BaseAgent("Test", "You are helpful.", temperature=1.0)
    ...
    def test_agent_max_tokens_configuration(self):
        ...
        agent_short = BaseAgent("Test", "You are helpful.", max_tokens=100)
        agent_medium = BaseAgent("Test", "You are helpful.", max_tokens=500)
        agent_long = BaseAgent("Test", "You are helpful.", max_tokens=2000)
